...
% Here we code the main programm for the Roe linearization
% Initial data set
data = 4;
g=1;
switch data
...
%plot of the solutions for 1.1 with periodic boundary conditions or open changing the data
dx=0.02;
xf = 0:dx:2;
...
if (data==1)
    ...
    legend('h obtained by ROE','exact solution');
    ...
    legend('m obtained by ROE','exact solution');
    hold off;
    ylim([-1.1 2]);xlim([0 2]);    
end
